...
<body class="page">
   <header class="header">
      <div class="header__container container">
         <a class="header__logotype logotype logotype_black" href="#">Escape.</a>
         <nav class="header__navigation navigation">
            <ul class="navigation__list container">
               <li class="navigation__item"><a class="navigation__link navigation__link_black" href="#">home</a></li>
               <li class="navigation__item"><a class="navigation__link navigation__link_black" href="#">categoris</a>
               </li>
               <li class="navigation__item"><a class="navigation__link navigation__link_black" href="#">about</a>
               </li>
               <li class="navigation__item"><a class="navigation__link navigation__link_black" href="#">contact</a>
               </li>
            </ul>
         </nav>
      </div>
